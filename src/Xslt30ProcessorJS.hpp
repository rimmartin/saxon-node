...
namespace saxon_node {
    ...
    public:
        ...
        static void Initialize(v8::Local<v8::Object> target) {
            ...
            target->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "Xslt30Processor", v8::NewStringType::kInternalized).ToLocalChecked(), t->GetFunction(context).ToLocalChecked());
        };
