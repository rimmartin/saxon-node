...
namespace saxon_node {
    ...
    public:
        ...
        static void Initialize(Handle<Object> target) {
            ...
            t->SetClassName(String::NewFromUtf8(v8::Isolate::GetCurrent(), "XdmValue"));
            ...
            target->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "XdmValue"), t->GetFunction());
        };
    ...
    private:
        ...
        static void addXdmValueWithType(const v8::FunctionCallbackInfo<Value>& args) {
        ...
        static void addXdmItem(const v8::FunctionCallbackInfo<Value>& args) {
            v8::Isolate::GetCurrent()->ThrowException(v8::Exception::SyntaxError(String::NewFromUtf8(v8::Isolate::GetCurrent(), "unsupported method")));
            args.GetReturnValue().SetUndefined();
        };

        static void getHead(const v8::FunctionCallbackInfo<Value>& args) {
            v8::Isolate::GetCurrent()->ThrowException(v8::Exception::SyntaxError(String::NewFromUtf8(v8::Isolate::GetCurrent(), "unsupported method")));
            args.GetReturnValue().SetUndefined();
        };

        static void itemAt(const v8::FunctionCallbackInfo<Value>& args) {
            v8::Isolate::GetCurrent()->ThrowException(v8::Exception::SyntaxError(String::NewFromUtf8(v8::Isolate::GetCurrent(), "unsupported method")));
            args.GetReturnValue().SetUndefined();
        };

        static void size(const v8::FunctionCallbackInfo<Value>& args) {
            v8::Isolate::GetCurrent()->ThrowException(v8::Exception::SyntaxError(String::NewFromUtf8(v8::Isolate::GetCurrent(), "unsupported method")));
            args.GetReturnValue().SetUndefined();
        };
