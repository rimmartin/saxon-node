...
namespace saxon_node {
    ...
    public:
        ...
        static void Initialize(v8::Local<v8::Object> target) {
            ...
            target->Set(context, v8::String::NewFromUtf8(v8::Isolate::GetCurrent(), "XdmAtomicValue", v8::NewStringType::kInternalized).ToLocalChecked(), t->GetFunction(context).ToLocalChecked());
        };
