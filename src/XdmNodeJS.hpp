...
namespace saxon_node {
    ...
    public:
        ...
        static void Initialize(v8::Local<v8::Object> target) {
            ...
            t->SetClassName(v8::String::NewFromUtf8(v8::Isolate::GetCurrent(), "XdmNode", v8::NewStringType::kInternalized).ToLocalChecked());
            ...
            target->Set(context, v8::String::NewFromUtf8(v8::Isolate::GetCurrent(), "XdmNode", v8::NewStringType::kInternalized).ToLocalChecked(), t->GetFunction(context).ToLocalChecked());
        };
    ...
    private:
        ...
        static void New(const v8::FunctionCallbackInfo<v8::Value>& args) {
            ...
            if (args.Length() < 1)
                ...
                xp = new XdmNodeJS(args[1]->ToBoolean(isolate)->Value());
