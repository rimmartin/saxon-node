...
namespace saxon_node {
    ...
    public:
        ...
        static void Initialize(v8::Local<v8::Object> target) {
            ...
            t->SetClassName(String::NewFromUtf8(v8::Isolate::GetCurrent(), "XsltProcessor", v8::NewStringType::kInternalized).ToLocalChecked());
    ...
    private:
        ...
        static void New(const v8::FunctionCallbackInfo<Value>& args) {
            ...
            if (args.Length() < 1)
                ...
                xp = new XsltProcessorJS(args[1]->ToBoolean(isolate)->Value());
...
//                            std::cout<<(*pn)<<" "<<(*pnValue)<<std::endl;
        ...
        static void transformToString(const v8::FunctionCallbackInfo<Value>& args) {
            ...
            if (args.Length() != 0) {
                ...
                v8::Isolate::GetCurrent()->ThrowException(v8::Exception::Error(String::NewFromUtf8(v8::Isolate::GetCurrent(), "no arg(s) expected", v8::NewStringType::kInternalized).ToLocalChecked()));
                args.GetReturnValue().SetUndefined();
                return;
